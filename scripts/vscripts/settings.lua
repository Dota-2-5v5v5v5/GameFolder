...
MAX_NUMBER_OF_TEAMS = 6                -- How many potential teams can be in this game mode?
...
TEAM_COLORS[DOTA_TEAM_CUSTOM_1] = { 255, 131, 0 }   --    Pink
TEAM_COLORS[DOTA_TEAM_CUSTOM_2] = { 42, 195, 234 }   --    Orange
TEAM_COLORS[DOTA_TEAM_CUSTOM_3] = { 0, 255, 128 }   --    Blue
TEAM_COLORS[DOTA_TEAM_CUSTOM_4] = { 234, 39, 194 }   --    Green
...
CUSTOM_TEAM_PLAYER_COUNT[DOTA_TEAM_CUSTOM_2] = 5
CUSTOM_TEAM_PLAYER_COUNT[DOTA_TEAM_CUSTOM_3] = 5
CUSTOM_TEAM_PLAYER_COUNT[DOTA_TEAM_CUSTOM_4] = 5
