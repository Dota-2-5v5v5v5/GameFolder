...
================================================================================================================= ]]
function item_power_treads_strength_datadriven_on_spell_start(keys)print("should swap")
	swap_to_item(keys, "item_powerfull_treads_intelligence_datadriven")print("swapped")
end
...
function item_power_treads_agility_datadriven_on_spell_start(keys)
	swap_to_item(keys, "item_powerfull_treads_strength_datadriven")
end
...
function item_power_treads_intelligence_datadriven_on_spell_start(keys)
	swap_to_item(keys, "item_powerfull_treads_agility_datadriven")
end