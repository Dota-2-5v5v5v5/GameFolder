...
--[[
  ...
  -Ensure that you have the trialsofretribution_notifications.xml, trialsofretribution_notifications.js, and trialsofretribution_notifications.css files in your panorama content folder.
  -Ensure that trialsofretribution_notifications.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/trialsofretribution_notifications.xml" />
